...
function init(){
  ...
  recommendedU = prompt("Please enter uri1", "http://dbpedia.org/resource/Tom_Hanks");
  fromU = prompt("Please enter uri2", "http://dbpedia.org/resource/Leonardo_DiCaprio");

  if(recommendedU != null && fromU != null){
    console.log(recommendedU);
    console.log(fromU);

    recommendedUri = recommendedU;
    fromUris.push(fromU);
